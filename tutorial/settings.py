...
SECRET_KEY = '_zn%oxjuj_47q^b-%kc34v5*ehd%xqm2qoq8#a*@vcrr*j2gf&'
...
# wskazanie na plik gdzie znajdują się podścieżki do naszej aplikacji urls
ROOT_URLCONF = 'tutorial.urls'
# templatki, jesli coś siądzie, można dopisać
TEMPLATES = [
    {
...
#sqllite3 zazwyczaj wystarczy, może być postgres
DATABASES = {
    'default': {
